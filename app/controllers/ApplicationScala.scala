...
class ApplicationScala extends Controller with Logging  {
...
//    //val jsSecurityRoutesClass = classOf[security.routes.javascript]
//    val controllers = jsRoutesClass.getFields.map(_.get(null))
//    //val controllersSecurity = jsSecurityRoutesClass.getFields.map(_.get(null))
//    val controllersAll = controllers //++ controllersSecurity ++ controllersJournal
//    controllersAll.flatMap { controller =>
